...
use crate::auth;
use crate::constants::{fishing, movement as movement_consts, network as network_consts, protocol as ids, timing, tutorial};
            ...
            _ = tokio::time::sleep(sleep_duration) => {
                ...
                if world_width == 0 {
                    ...
                    if is_in_mine {
                        ...
                        let move_pkts = protocol::make_move_to_map_point(player_x, player_y, player_x, player_y, movement_consts::ANIM_IDLE, movement_consts::DIR_LEFT);
                        ...
                        match resolved_path {
                            Some(path) => {
                                if path.len() > 1 {
                                    ...
                                    let dir = if target_x > player_x { movement_consts::DIR_RIGHT } else { movement_consts::DIR_LEFT };
                                    ...
                                    if move_blocked {
                                        ...
                                        let anim = movement_consts::ANIM_FALL;
